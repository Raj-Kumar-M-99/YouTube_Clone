...
export const SideBar = () => {
  ...
  return (
   ...
   `}>
    ...
    <LargeSidebarSection>
        <LargeSidebarItem isActive title="Home" url="/" IconOrImgUrl={Home}/>
        <LargeSidebarItem title="Subscriptions" url="/subscriptions" IconOrImgUrl={Clapperboard}/>
    </LargeSidebarSection>
    <hr />
...
function LargeSidebarItem({IconOrImgUrl,title,url,isActive=false}:LargeSidebarSection){
