...
export const VideoGridItem = ({id,title,channel,views,postedAt,duration,thumbnailUrl,videoUrl}:VideoGridItemProps) => {
    ...
    onMouseLeave={()=>setIsVideoplaying(false)}>
       <a href={`/watch?v=${id}`} className="relative aspect-video">
        ...
        transition-[border-radius] duration-200 ${isVideoPlaying?"rounded-none":"rounded-xl"}`}
        />
        <div className="absolute bottom-1 right-1 
       bg-secondary-dark text-secondary text-sm px-0.5
           rounded">
    {formatDuration(duration)}
        ...
        transition-opacity duration-200 ${isVideoPlaying ? "opacity-100 delay-200  ":
       ...
       <div className="flex gap-2">
          ...
          <div className="flex flex-col">
              ...
              <div className="text-secondary-text text-s,
               ">
